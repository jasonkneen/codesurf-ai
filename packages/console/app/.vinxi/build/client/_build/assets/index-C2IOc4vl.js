...
import { c as createAsync, a as createServerReference } from './server-runtime-BVQMvLQK.js';
...
const checkLoggedIn = query(checkLoggedIn_query, "checkLoggedIn.get");
function Home() {
  createAsync(() => checkLoggedIn());
  return (() => {
    var _el$ = getNextElement(_tmpl$4), _el$52 = _el$.firstChild, [_el$53, _co$4] = getNextMarker(_el$52.nextSibling), _el$54 = _el$53.nextSibling, [_el$55, _co$5] = getNextMarker(_el$54.nextSibling), _el$56 = _el$55.nextSibling, [_el$57, _co$6] = getNextMarker(_el$56.nextSibling), _el$58 = _el$57.nextSibling, [_el$59, _co$7] = getNextMarker(_el$58.nextSibling), _el$60 = _el$59.nextSibling, [_el$61, _co$8] = getNextMarker(_el$60.nextSibling), _el$62 = _el$61.nextSibling, [_el$63, _co$9] = getNextMarker(_el$62.nextSibling), _el$2 = _el$63.nextSibling, _el$50 = _el$2.firstChild, [_el$51, _co$3] = getNextMarker(_el$50.nextSibling), _el$3 = _el$51.nextSibling, _el$4 = _el$3.firstChild, _el$5 = _el$4.firstChild, _el$6 = _el$5.firstChild, _el$7 = _el$6.nextSibling, _el$8 = _el$4.nextSibling, _el$9 = _el$8.firstChild, _el$0 = _el$8.nextSibling, _el$1 = _el$0.nextSibling, _el$10 = _el$1.nextSibling, _el$11 = _el$10.nextSibling, _el$12 = _el$11.firstChild, _el$13 = _el$12.firstChild, _el$14 = _el$13.firstChild, _el$15 = _el$14.firstChild, _el$16 = _el$12.nextSibling, _el$17 = _el$16.firstChild, _el$18 = _el$17.firstChild, _el$19 = _el$18.firstChild, _el$20 = _el$16.nextSibling, _el$21 = _el$20.firstChild, _el$22 = _el$21.firstChild, _el$23 = _el$22.firstChild, _el$24 = _el$20.nextSibling, _el$25 = _el$24.firstChild, _el$26 = _el$25.firstChild, _el$27 = _el$26.firstChild, _el$28 = _el$24.nextSibling, _el$29 = _el$28.firstChild, _el$30 = _el$29.firstChild, _el$31 = _el$30.firstChild, _el$32 = _el$11.nextSibling, _el$33 = _el$32.firstChild, _el$34 = _el$33.nextSibling, _el$35 = _el$34.firstChild, _el$36 = _el$35.nextSibling, _el$37 = _el$36.nextSibling, _el$38 = _el$37.nextSibling, _el$41 = _el$38.nextSibling, _el$43 = _el$41.nextSibling, _el$44 = _el$43.nextSibling, _el$45 = _el$44.nextSibling, _el$46 = _el$32.nextSibling, [_el$47, _co$] = getNextMarker(_el$46.nextSibling), _el$48 = _el$47.nextSibling, [_el$49, _co$2] = getNextMarker(_el$48.nextSibling), _el$64 = _el$2.nextSibling, [_el$65, _co$0] = getNextMarker(_el$64.nextSibling);
    insert(_el$, createComponent(HttpHeader, {
      name: "Cache-Control",
      value: "public, max-age=1, s-maxage=3600, stale-while-revalidate=86400"
    }), _el$53, _co$4);
    insert(_el$, createComponent(Title, {
      children: "OpenCode Zen | A curated set of reliable optimized models for coding agents"
    }), _el$55, _co$5);
    insert(_el$, createComponent(Link, {
      rel: "canonical",
      get href() {
        return `${config.baseUrl}/zen`;
      }
    }), _el$57, _co$6);
    insert(_el$, createComponent(Link, {
      rel: "icon",
    ...
    setAttribute(_el$6, "src", zenLogoLight);
    setAttribute(_el$7, "src", zenLogoDark);
    setAttribute(_el$9, "src", compareVideo);
    setAttribute(_el$9, "poster", compareVideoPoster);
    setAttribute(_el$15, "src", avatarDax);
    setAttribute(_el$19, "src", avatarJay);
    setAttribute(_el$23, "src", avatarAdam);
    setAttribute(_el$27, "src", avatarDavid);
    setAttribute(_el$31, "src", avatarFrank);
    insert(_el$35, createComponent(Faq, {
      question: "What is OpenCode Zen?",
      children: "Zen is a curated set of AI models tested and benchmarked for coding agents created by the team behind OpenCode."
    }));
    insert(_el$36, createComponent(Faq, {
      question: "What makes Zen more accurate?",
      children: "Zen only provides models that have been specifically tested and benchmarked for coding agents. You wouldn’t use a butter knife to cut steak, don’t use poor models for coding."
    }));
    insert(_el$37, createComponent(Faq, {
      question: "Is Zen cheaper?",
      children: "Zen is not for profit. Zen passes through the costs from the model providers to you. The higher Zen’s usage the more OpenCode can negotiate better rates and pass those to you."
    }));
    insert(_el$38, createComponent(Faq, {
      question: "How much does Zen cost?",
      get children() {
        return ["Zen ", getNextElement(_tmpl$), " with zero markups, so you pay exactly what the model provider charges. Your total cost depends on usage, and you can set monthly spend limits in your ", getNextElement(_tmpl$2), ". To cover costs, OpenCode adds only a small payment processing fee of $1.23 per $20 balance top-up."];
      }
    }));
    insert(_el$41, createComponent(Faq, {
      question: "What about data and privacy?",
      get children() {
        return ["All Zen models are hosted in the US. Providers follow a zero-retention policy and do not use your data for model training, with the ", getNextElement(_tmpl$3), "."];
      }
    }));
    insert(_el$43, createComponent(Faq, {
      question: "Can I set spend limits?",
      children: "Yes, you can set monthly spending limits in your account."
    }));
    insert(_el$44, createComponent(Faq, {
      question: "Can I cancel?",
      children: "Yes, you can disable billing at any time and use your remaining balance."
    }));
    insert(_el$45, createComponent(Faq, {
      question: "Can I use Zen with other coding agents?",
      children: "While Zen works great with OpenCode, you can use Zen with any agent. Follow the setup instructions in your preferred coding agent."
    }));
    insert(_el$3, createComponent(EmailSignup, {}), _el$47, _co$);
    insert(_el$3, createComponent(Footer, {}), _el$49, _co$2);
    insert(_el$, createComponent(Legal, {}), _el$65, _co$0);
    return _el$;
  })();
}

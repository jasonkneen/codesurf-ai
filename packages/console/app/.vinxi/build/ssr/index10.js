...
function Enterprise() {
  ...
  })), escape(createComponent(Header, {})), escape(createComponent(Show, {
    when: false,
    get children() {
      return ssr(_tmpl$, ssrHydrationKey());
    }
  })), ssrAttribute("value", escape(formData().name, true), false), ssrAttribute("value", escape(formData().role, true), false), ssrAttribute("value", escape(formData().email, true), false), ssrAttribute("value", escape(formData().message, true), false), ssrAttribute("disabled", isSubmitting(), true), isSubmitting() ? "Sending..." : "Send", showSuccess() && _tmpl$3[0] + ssrHydrationKey() + _tmpl$3[1], escape(createComponent(Faq, {
  ...
  })), escape(createComponent(Footer, {})), escape(createComponent(Legal, {})));
}
export {
  Enterprise as default
};

import { mysqlTable, varchar, int, boolean, bigint, uniqueIndex } from "drizzle-orm/mysql-core";
import { u as utc, t as timestamps, w as workspaceColumns, b as workspaceIndexes, a as ulid } from "./workspace.sql-DMfPBlPl.js";
const BillingTable = mysqlTable("billing", {
  ...workspaceColumns,
  ...timestamps,
  ...
  reloadError: varchar("reload_error", {
    length: 255
  }),
...
const PaymentTable = mysqlTable("payment", {
  ...workspaceColumns,
  ...timestamps,
  customerID: varchar("customer_id", {
    length: 255
...
const UsageTable = mysqlTable("usage", {
  ...workspaceColumns,
  ...timestamps,
  model: varchar("model", {
    length: 255

...
import { T as Title, L as Link, a as Meta } from "./assets/index-D2bc-ZG5.js";
import { H as HttpHeader, E as EmailSignup } from "./assets/email-signup-UxJGsZLa.js";
import { c as config, H as Header, F as Footer, L as Legal } from "./assets/legal-BR_P0qLz.js";
import { F as Faq } from "./assets/faq-Ct4DFiDZ.js";
...
import { q as query } from "./assets/query-D38s0pjD.js";
...
import "./assets/components-DamWUrce.js";
...
function Home() {
  ...
  return ssr(_tmpl$4, ssrHydrationKey(), escape(createComponent(HttpHeader, {
    name: "Cache-Control",
    value: "public, max-age=1, s-maxage=3600, stale-while-revalidate=86400"
  })), escape(createComponent(Title, {
    ...
    zen: true
  })), ssrAttribute("src", escape(zenLogoLight, true), false), ssrAttribute("src", escape(zenLogoDark, true), false), ssrAttribute("src", escape(compareVideo, true), false), ssrAttribute("poster", escape(compareVideoPoster, true), false), ssrAttribute("src", escape(avatarDax, true), false), ssrAttribute("src", escape(avatarJay, true), false), ssrAttribute("src", escape(avatarAdam, true), false), ssrAttribute("src", escape(avatarDavid, true), false), ssrAttribute("src", escape(avatarFrank, true), false), escape(createComponent(Faq, {
    ...
    get children() {
      return ["Zen ", ssr(_tmpl$, ssrHydrationKey()), " with zero markups, so you pay exactly what the model provider charges. Your total cost depends on usage, and you can set monthly spend limits in your ", ssr(_tmpl$2, ssrHydrationKey()), ". To cover costs, OpenCode adds only a small payment processing fee of $1.23 per $20 balance top-up."];
    }
  })), escape(createComponent(Faq, {
    question: "What about data and privacy?",
    get children() {
      return ["All Zen models are hosted in the US. Providers follow a zero-retention policy and do not use your data for model training, with the ", ssr(_tmpl$3, ssrHydrationKey()), "."];
    }
  })), escape(createComponent(Faq, {
  ...
  })), escape(createComponent(EmailSignup, {})), escape(createComponent(Footer, {})), escape(createComponent(Legal, {})));
}
export {
  Home as default
};

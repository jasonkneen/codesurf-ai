import { isServer, createComponent as createComponent$1, mergeProps as mergeProps$1, ssr, ssrHydrationKey, escape, ssrAttribute } from "solid-js/web";
/* empty css                      */
import { T as Title, L as Link, M as Meta } from "./assets/index-DaW7GtZQ.js";
import { createMemo, useContext, createContext, createSignal, onMount, onCleanup, createEffect, on, mergeProps, createComputed, createComponent, createUniqueId, splitProps, Show } from "solid-js";
...
import { i as isString, a as isNumber, f as focusWithoutScrolling, s as scrollIntoView, c as callHandler, g as getFocusableTreeWalker, m as mergeDefaultProps, b as isAppleDevice, d as isMac, e as createControllableSignal, h as createControllableArraySignal, j as getDocument, k as addItemToArray, P as Polymorphic, l as composeEventHandlers, n as src_default, o as isWebKit, _ as __export, F as Faq } from "./assets/faq-Ct4DFiDZ.js";
import { access } from "@solid-primitives/utils";
import { createEventListener } from "@solid-primitives/event-listener";
import { combineStyle } from "@solid-primitives/props";
import { createResizeObserver } from "@solid-primitives/resize-observer";
import { H as Header, F as Footer, L as Legal, g as github } from "./assets/legal-DqlkVGvI.js";
...
const video = "/_server/assets/opencode-min-Chv3y3qO.mp4";
const videoPoster = "/_server/assets/opencode-poster-CbUiDHgA.png";
      ...
      case (orientation() === "vertical" ? "ArrowLeft" : "ArrowUp"): {
        if (delegate.getKeyLeftOf) {
          ...
          if (focusedKey != null) {
            ...
            nextKey = isRTL2 ? delegate.getFirstKey?.() : delegate.getLastKey?.();
          }
          navigateToKey(nextKey);
        }
        break;
      ...
      case (orientation() === "vertical" ? "ArrowRight" : "ArrowDown"): {
        if (delegate.getKeyRightOf) {
          ...
          if (focusedKey != null) {
            ...
            nextKey = isRTL2 ? delegate.getLastKey?.() : delegate.getFirstKey?.();
          }
          navigateToKey(nextKey);
        }
        break;
...
function TabsContent(props) {
  ...
  return createComponent$1(Show, {
    ...
    get children() {
      return createComponent$1(Polymorphic, mergeProps$1({
        as: "div",
        get id() {
          return id();
        },
...
function TabsRoot(props) {
  ...
  return createComponent$1(DomCollectionProvider, {
    get children() {
      return createComponent$1(TabsContext.Provider, {
        value: context,
        get children() {
          return createComponent$1(Polymorphic, mergeProps$1({
            as: "div",
...
function TabsTrigger(props) {
  ...
  return createComponent$1(Polymorphic, mergeProps$1({
    ...
    role: "tab",
    get tabIndex() {
      return !isDisabled() ? selectableItem.tabIndex() : void 0;
    },
    get disabled() {
      return isDisabled();
    },
    ...
    get ["aria-controls"]() {
      return selectableItem.isSelected() ? contentId() : void 0;
    },
    get ["data-key"]() {
...
function Home() {
  ...
  return ssr(_tmpl$13, ssrHydrationKey(), escape(createComponent$1(HttpHeader, {
    name: "Cache-Control",
    value: "public, max-age=1, s-maxage=3600, stale-while-revalidate=86400"
  })), escape(createComponent$1(Title, {
    ...
    type: "image/svg+xml",
    href: "/favicon.svg"
  })), escape(createComponent$1(Meta, {
    property: "og:image",
    content: "/social-share.png"
  })), escape(createComponent$1(Meta, {
    name: "twitter:image",
    content: "/social-share.png"
  })), escape(createComponent$1(Header, {})), ssrAttribute("href", escape(release()?.url, true) ?? `${escape(config.github.repoUrl, true)}/releases`, false), escape(release()?.name) ?? "the latest release", escape(createComponent$1(Tabs, {
    as: "section",
    ...
    defaultValue: "curl",
    get children() {
      return [createComponent$1(Tabs.List, {
        "data-slot": "tablist",
        get children() {
          return [createComponent$1(Tabs.Trigger, {
            value: "curl",
            "data-slot": "tab",
            children: "curl"
          }), createComponent$1(Tabs.Trigger, {
            value: "npm",
            "data-slot": "tab",
            children: "npm"
          }), createComponent$1(Tabs.Trigger, {
            ...
            "data-slot": "tab",
            children: "paru"
          }), createComponent$1(Tabs.Indicator, {})];
        }
      }), ssr(_tmpl$7, ssrHydrationKey(), escape(createComponent$1(Tabs.Content, {
        as: "pre",
        "data-slot": "panel",
        value: "curl",
        get children() {
          return ssr(_tmpl$2, ssrHydrationKey(), escape(createComponent$1(CopyStatus, {})));
        }
      })), escape(createComponent$1(Tabs.Content, {
        as: "pre",
        "data-slot": "panel",
        value: "npm",
        get children() {
          return ssr(_tmpl$3, ssrHydrationKey(), escape(createComponent$1(CopyStatus, {})));
        }
      })), escape(createComponent$1(Tabs.Content, {
        as: "pre",
        "data-slot": "panel",
        value: "bun",
        get children() {
          return ssr(_tmpl$4, ssrHydrationKey(), escape(createComponent$1(CopyStatus, {})));
        }
      })), escape(createComponent$1(Tabs.Content, {
        as: "pre",
        "data-slot": "panel",
        value: "brew",
        get children() {
          return ssr(_tmpl$5, ssrHydrationKey(), escape(createComponent$1(CopyStatus, {})));
        }
      })), escape(createComponent$1(Tabs.Content, {
        as: "pre",
        "data-slot": "panel",
        value: "paru",
        get children() {
          return ssr(_tmpl$6, ssrHydrationKey(), escape(createComponent$1(CopyStatus, {})));
        }
      })))];
    }
  })), ssrAttribute("src", escape(video, true), false), ssrAttribute("poster", escape(videoPoster, true), false), escape(config.github.starsFormatted.full), escape(config.stats.contributors), escape(config.stats.commits), escape(config.stats.monthlyUsers), escape(config.github.starsFormatted.compact), escape(config.stats.contributors), escape(config.stats.monthlyUsers), escape(createComponent$1(Faq, {
  ...
  })), escape(createComponent$1(Faq, {
    question: "How do I use OpenCode?",
    get children() {
      return ["The easiest way to get started is to read the ", ssr(_tmpl$8, ssrHydrationKey()), "."];
    }
  })), escape(createComponent$1(Faq, {
    question: "Do I need extra AI subscriptions to use OpenCode?",
    get children() {
      return ["Not necessarily, but probably. You’ll need an AI subscription if you want to connect OpenCode to a paid provider, although you can work with", " ", ssr(_tmpl$9, ssrHydrationKey()), " ", "for free. While we encourage users to use ", createComponent$1(A, {
        href: "/zen",
        children: "Zen"
    ...
    get children() {
      return ["OpenCode is 100% free to use. Any additional costs will come from your subscription to a model provider. While OpenCode works with any model provider, we recommend using ", createComponent$1(A, {
        href: "/zen",
        children: "Zen"
      }), "."];
    }
    ...
    get children() {
      return ["Your data and information is only stored when you create sharable links in OpenCode. Learn more about", " ", ssr(_tmpl$0, ssrHydrationKey()), "."];
    }
  })), escape(createComponent$1(Faq, {
    question: "Is OpenCode open source?",
    get children() {
      return ["Yes, OpenCode is fully open source. The source code is public on", " ", ssr(_tmpl$1, ssrHydrationKey() + ssrAttribute("href", escape(config.github.repoUrl, true), false)), " ", "under the", " ", ssr(_tmpl$10, ssrHydrationKey(), `${escape(config.github.repoUrl, true)}?tab=MIT-1-ov-file#readme`), ", meaning anyone can use, modify, or contribute to its development. Anyone from the community can file issues, submit pull requests, and extend functionality."];
    }
  ...
  })), escape(createComponent$1(EmailSignup, {})), escape(createComponent$1(Footer, {})), escape(createComponent$1(Legal, {})));
}
export {
  Home as default
};
